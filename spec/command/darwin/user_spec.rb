...
describe get_command(:check_user_has_login_item, 'foo', 'Foo Bar') do
  it { should eq 'defaults read /Users/foo/Library/Preferences/com.apple.loginitems SessionItems | grep -E Name\\ =\\ \\"?Foo\\ Bar\\"?\\;' }
end
